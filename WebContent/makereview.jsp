    ...
    <div class="poi" style="width: 100%">
        <%
            PontoDeInteresse pontoDeInteresse = (PontoDeInteresse) request.getAttribute("poi");
             ...
             out.print("alt=\"Pineapple\" style=\"width:170px;height:170px;\"></p><h1><a href=\"openPOI?");
             out.print(pontoDeInteresse.getIdPontoInteresse() + "\" >" + pontoDeInteresse.getName() + "</a></h1><p>");
