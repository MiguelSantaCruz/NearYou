...
<%@ page import="Model.*" %>
<%@ page import="DataBase.PontoDeInteresseDAO" %>
<%@ page import="DataBase.UtilizadorPiDAO" %>
...
<div class=" w3-container" style="background-color: darkorange">
    ...
    <div class="container">
        ...
        out.print("<h>" + apiHandler.localizautilizador() + "</h></h1>");
    %>
    </div>
    ...
    <div class="w3-row w3-border">
        <h1> Reviews: </h1>
            <div class="w3-twothird w3-container" style="color: black">
                <%
                    List<Review> reviewList = ReviewDAO.get_all_reviews_user(utilizador.getUserID());
            ...
            <div class="w3-third w3-container">
                ...
                <%
                    List<PontoDeInteresse> pontoDeInteresseList =  UtilizadorPiDAO.get_All_Pis_Users(utilizador.getUserID());
